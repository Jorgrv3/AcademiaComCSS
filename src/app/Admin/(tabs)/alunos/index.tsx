...
export default function Index() {
   ...
   useEffect(()=> {
    ...
    return(
        <View style={[aulasStyle.bigView,{alignItems:'center'}]}>
            <View style={{justifyContent:'center',flexDirection:'row'}}>
                <TouchableOpacity onPress={() => router.navigate('/Admin/(tabs)/alunos/addalunos')}>
                ...
                <View style={{justifyContent:'center', alignItems:'center'}}>
                    <Text>
                        {alunos?null:'Nenhum aluno cadastrado'}
                    </Text>
                </View>
            <View style={{}}>
                <FlatList
