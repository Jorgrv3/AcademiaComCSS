...
export default function Index() {
    ...
    return(
        <View style={aulasStyle.bigView}>
            <Text style={[aulasStyle.bigText, styles.bold]}> {meses[Number(params.mes)-1]}</Text>
            <View style={{flexDirection:'row', alignSelf:'center'}}>
                <Text style={[styles.bold,aulasStyle.bigText]}>Ano: </Text>
                <Text style={aulasStyle.bigText}>{anoAtual}</Text>
            </View>
